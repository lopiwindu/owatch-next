import { Bell, Shield, Palette, Globe, Download, Trash2, ToggleLeft as Toggle } from 'lucide-react'
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600">Get weekly activity summary</p>
              </div>
              <button
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                  privacy.analyticsData ? 'bg-blue-600' : 'bg-gray-200'
                }`}
              >
                <span
                  className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600">Accept cookies for better experience</p>
              </div>
              <button
                onClick={() => togglePrivacy('cookieConsent')}
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                  privacy.cookieConsent ? 'bg-blue-600' : 'bg-gray-200'
                }`}
              >
                <span
                  className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-3">
                <button className="p-3 border-2 border-blue-600 rounded-lg bg-blue-50">
                  ...
                  <p className="text-xs font-medium text-blue-600">Light</p>
                </button>
                ...
                <button className="p-3 border border-gray-200 rounded-lg hover:border-gray-300">
                  ...
                  <p className="text-xs font-medium text-gray-600">Auto</p>
                </button>
              </div>
            </div>
